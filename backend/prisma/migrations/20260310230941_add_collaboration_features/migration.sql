/*
  ...
  - Added the required column `order` to the `WorkPart` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "WorkPart" ADD COLUMN     "order" INTEGER NOT NULL;
